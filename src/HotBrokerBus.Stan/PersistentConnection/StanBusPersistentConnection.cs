...
namespace HotBrokerBus.Stan.PersistentConnection
{
    public class StanBusPersistentConnection : IStanBusPersistentConnection
    {
        ...
        public async Task SetupReconnect()
        {
        ...
        {
            async void ConnectionLostHandler(object? obj, StanConnLostHandlerArgs args) => await SetupReconnect();
            
            _stanModulesOptions.ConnectionOptions.StanOptionsOptions.StanOptions.ConnectionLostEventHandler = ConnectionLostHandler;
        }
